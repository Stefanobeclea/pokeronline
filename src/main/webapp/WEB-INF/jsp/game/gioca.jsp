	  	...
	  	<div class="container">
			...
			<div class='card'>
			    ...
			    <div class='card-footer'>
					<form action="${pageContext.request.contextPath}/game/giocata/${show_tavolo_attr.id}" method="post">
						  <button type="submit" name="submit" id="submit" class="btn btn-primary">Gioca</button>
						       <a href="${pageContext.request.contextPath}/game" class='btn btn-outline-secondary' style='width:80px'>
